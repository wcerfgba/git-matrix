...
//!/usr/bin/env coffee
// @flow
var ChangeCountMatrix, ChangesObjectStream, CommitCountMatrix, GIT_CMD, GIT_SPAWN_CMD, Readable, UnknownMatrixError, argv, createReadStream, createWriteStream, exec, matrixToHtml, spawn, util, yargs;
